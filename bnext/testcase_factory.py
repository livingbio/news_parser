...
# ========================================================================================
		...
		utility_string2 = 'https://graph.facebook.com/comments?id={}&filter=stream&fields=parent.fields(id),message,from,created_time,like_count{}' # + '&limit=3' # limit is just for testing
		...
		while True:
			...
			_pseudo_request_response_dict[utility_string2.format(url, suffix)] = res_fb2
...
# ========================================================================================
	pkl.dump(_pseudo_request_response_dict, open('./resources/_pseudo_request_response_dict.pkl', 'w'))
