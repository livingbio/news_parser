...
def main():
    ...
    with open('./setn/resources/target.pickle', 'wb') as f:
        pickle.dump((cate_urls, result, time_now), f, protocol=1)

    with open('/setn/resources/resps.pickle', 'wb') as f:
        pickle.dump(collect, f, protocol=1)
